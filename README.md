...
1. Detects frequencies from the audio (using [ACF2+](https://whatnoteisthis.com/)),
2. Determines the key (by detecting notes with [Goertzel Algorithm](https://en.wikipedia.org/wiki/Goertzel_algorithm), and using a heuristic [Bayesian model](https://davidtemperley.com/wp-content/uploads/2015/12/temperley-ms04.pdf)),
